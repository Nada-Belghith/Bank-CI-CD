    ...
    stages {
        ...
        stage('Post-Deployment Performance Test') {
            steps {
                ...
                sh """
                    JVM_ARGS="-Djava.net.preferIPv4Stack=true" ${env.JMETER_HOME}/bin/jmeter -n -t jmeter/performance_test_docker.jmx -l results_docker.jtl -Jhost=127.0.0.1 -Jport=8083
                """
            }
            post {
                always {
